package com.riprog.launcher.core.theme

import com.riprog.launcher.core.preferences.LauncherPreferences
import com.riprog.launcher.core.theme.modules.AcrylicTheme
import com.riprog.launcher.core.theme.modules.StandardTheme
import com.riprog.launcher.core.theme.modules.ThemeModule
...
object ThemeUtils {
    ...
    private fun getModule(settingsManager: LauncherPreferences): ThemeModule {
        return if (settingsManager.isAcrylic) AcrylicTheme else StandardTheme
    }

    fun getThemedSurface(context: Context, settingsManager: LauncherPreferences): Drawable {
        return getThemedSurface(context, settingsManager, 28f)
    }

    fun getThemedSurface(context: Context, settingsManager: LauncherPreferences, cornerRadiusDp: Float): Drawable {
    ...
    fun getAdaptiveColor(context: Context, settingsManager: LauncherPreferences, isOnAcrylic: Boolean): Int {
