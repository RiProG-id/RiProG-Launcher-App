...
class TransformOverlay @JvmOverloads constructor(
    ...
    private val settingsManager: LauncherPreferences? = null,
    ...
    private val contentBounds: RectF
        get() {
            return if (targetView != null) WidgetUtils.getVisualBounds(targetView) else RectF()
        }
    ...
    private fun drawSnapPreview(canvas: Canvas) {
        ...
        val vBounds = WidgetUtils.getVisualBounds(targetView)
