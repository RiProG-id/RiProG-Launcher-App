...
public class SettingsActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rootContainer.setBackground(ThemeUtils.getGlassDrawable(this, settingsManager, 0f));
    ...
    private void addToggleSetting(LinearLayout parent, int titleRes, int summaryRes, boolean initialValue, OnSettingChangeListener listener) {
        LinearLayout item = new LinearLayout(this);
        item.setOrientation(LinearLayout.HORIZONTAL);
        item.setGravity(Gravity.CENTER_VERTICAL);
        item.setPadding(dpToPx(16), dpToPx(16), dpToPx(16), dpToPx(16));
        ThemeUtils.applySettingItemStyle(this, item, settingsManager);

        LinearLayout textLayout = new LinearLayout(this);
        textLayout.setOrientation(LinearLayout.VERTICAL);
        item.addView(textLayout, new LinearLayout.LayoutParams(0, ViewGroup.LayoutParams.WRAP_CONTENT, 1f));
